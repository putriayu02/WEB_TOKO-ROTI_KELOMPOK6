...
<html>
<head>
	<title>VesuBakery & Cookies</title>
		...
		<div class="row top">
			<center>
				<div class="col-md-4" style="padding: 3px;">
					<span> <i class="glyphicon glyphicon-earphone"></i> +6285693770296</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span><i class="glyphicon glyphicon-envelope"></i> vesubakey@gmail.com</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span>VesuBakery & Cookies Indonesia</span>
				</div>
			</center>
		</div>
	</div>
	...
	<nav class="navbar navbar-default" style="padding: 5px;">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#" style="color: #ff8680"><b>VesuBakery & Cookies</b></a>
			</div>
